...
public class VideoApi {
     ...
     */
    @PostMapping("/videos")
    public JsonResponse<String> addVideos(@RequestBody Video video) throws Exception {
    ...
    public JsonResponse<String> addVideoLike(@RequestParam Long videoId) throws Exception {
        Long userId = userSupport.getCurrentUserId();
    ...
    public JsonResponse<String> deleteVideoLike(@RequestParam Long videoId) throws Exception {
        Long userId = userSupport.getCurrentUserId();
    ...
    public JsonResponse<String> addVideoCollection(@RequestBody VideoCollection videoCollection) throws Exception {
        Long userId = userSupport.getCurrentUserId();
    ...
    public JsonResponse<String> deleteVideoCollection(@RequestParam Long videoId) throws Exception {
        Long userId = userSupport.getCurrentUserId();
    ...
    public JsonResponse<String> addVideoCoins(@RequestBody VideoCoin videoCoin) throws Exception {
        Long userId = userSupport.getCurrentUserId();
    ...
    public JsonResponse<String> addVideoComment(@RequestBody VideoComment videoComment) throws Exception {
        Long userId = userSupport.getCurrentUserId();
